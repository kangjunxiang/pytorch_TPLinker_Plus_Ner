...
class BertForNer:
    def __init__(self, args, train_loader, dev_loader, test_loader, idx2tag, model, device, test_callback=None):
    ...
    def predict(self, raw_text, model_path):
        ...
        with torch.no_grad():
            ...
            tokens = ['<[BOS_never_used_51bce0c785ca2f68081bfa7d91973934]>'] + tokens + ['<[BOS_never_used_51bce0c785ca2f68081bfa7d91973934]>']
